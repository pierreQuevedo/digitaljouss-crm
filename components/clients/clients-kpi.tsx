// app/dashboard/clients/kpi/page.tsx
"use client";
    ...
    async function fetchKpi() {
      ...
      if (error) {
        ...
        const rows = (data ?? []).map((c) => ({
          ...
          nb_contrats_actifs:
            c.nb_contrats_actifs === null ||
            c.nb_contrats_actifs === undefined
              ? null
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Basé sur le statut{" "}
              <span className="font-semibold">client actif</span>.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Somme de <code>nb_contrats_actifs</code> sur tous les clients.
            </p>
          </CardContent>
        </Card>
      </div>
